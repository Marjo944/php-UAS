	...
	<div class="container-fluid">
		<div class="row top">
			<center>
				...
				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> simbolonmarjo55@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>sidikalang city</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color:rgb(9, 16, 236)"><b>UD MARJO SIMBOLON</b></a>
			</div>
